...
const ROUTES = [
  {
    ...
    title: 'Сайт медицинской клиники DARI — кейс Tuiana Design',
    description:
      'Кейс разработки сайта клиники DARI: структура услуг, специалисты, юридические требования, адаптивный дизайн и единая понятная система для пациента.',
  },
  {
    out: 'projects/baza',
